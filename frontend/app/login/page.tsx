      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl shadow-2xl shadow-black/50 overflow-hidden">
          ...
          <div className="px-8 pt-8 pb-6 border-b border-zinc-800">
            ...
            <h1 className="text-lg font-semibold text-zinc-100">Sign in to your account</h1>
            <p className="text-sm text-zinc-500 mt-1 font-normal">Welcome back — enter your credentials below</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-emerald-400 hover:text-emerald-300 cursor-pointer transition font-normal">Forgot password?</span>
                </div>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg className="w-4 h-4 text-zinc-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
